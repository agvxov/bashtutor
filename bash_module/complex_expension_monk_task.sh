...
")
    ...
    echo "  $ base64 (--decode)"
    echo "You can use this to communicate in their anchient language called base-64." \
         "By adding '--decode' as an argument you will be understand them." \
