function description() {
    ...
    echo "  ${ITALICS}Name: A word consisting only of letters, digits and underscores,"
    echo "and beginning with a letter or an underscore. Also referred to as an identifier.${NORMAL}"
    echo ""
    ...
    echo "  $ varname=vardata"
    echo "This command assigns the data vardata to the variable by name of varname."
    echo "Please note that ${BOLD}you cannot use spaces around the = sign${NORMAL}" \
